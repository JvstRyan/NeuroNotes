...
const handleCheckBox = () => {
  ...
  return (
    <>
     <Box w={{ base: '350px', md: '560px'}} mt={'1rem'} p={'15px'} pb={'1.45rem'}  borderBottom={'2px solid #000'}>
          ...
          <Text isTruncated as={isChecked ? 'del' : 'b'} borderRadius={'5px'} color={'black'} fontWeight={'600'} fontSize={'18px'}>{goal}</Text>
          </Flex>
          <Flex gap={'1rem'}>
